 ...
 * @author Icarus James
 */
class EmpDataLoggerMain 
{
	private static var s_app: EmpDataLoggerMod;
	...
	{
		s_app = new EmpDataLoggerMod(swfRoot);
	 ...
	 */
	public function EmpDataLoggerMain() { }
	...
	/**
	 * This is your OnLoad event handler. OnUnLoad is called on logout.
	 * I recommend that you:
